...
export const BannerDescuento = () => {
  return (
    <div className="container">
        ...
        <p className="banner-texto">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel accusantium quis tempore vitae nesciunt esse. Eos odit sint ducimus sapiente reprehenderit asperiores dicta excepturi. Vel accusantium quis tempore vitae nesciunt esse. Eos odit sint ducimus sapiente reprehenderit asperiores dicta excepturi.</p>
