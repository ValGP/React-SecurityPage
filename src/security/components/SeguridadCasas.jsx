...
export const SeguridadCasas = () => {
  return (
    <div className="row">
            ...
            <div className="col-6 my-auto container-casas d-flex justify-content-between">
                <div className="row d-flex">
                    <div className="col-3 item-casa mx-auto mt-5">
                    ...
                    <div className="col-3 item-casa mx-auto">
                ...
                <div className="row">
                    ...
                    <div className="col-3 item-casa mx-auto mb-5">
